...
class Game6 extends StatefulWidget {
  const Game6({Key? key}) : super(key: key);
...
class _Game6State extends State<Game6> {
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      home: Scaffold(
        key: _scaffoldKey,
        appBar: AppBar(
          title: const Text('Unity Flutter Game Scene 6'),
        ),
        body: Card(
  ...
  void onUnityCreated(controller) {
    ...
    _unityWidgetController?.postMessage("Canvas", "OnReceiveStringMessage", "LoadScene6");
  }
