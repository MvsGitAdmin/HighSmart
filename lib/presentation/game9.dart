...
class Game9 extends StatefulWidget {
  const Game9({Key? key}) : super(key: key);
...
class _Game9State extends State<Game9> {
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      home: Scaffold(
        key: _scaffoldKey,
        appBar: AppBar(
          title: const Text('Unity Flutter Game Scene 9'),
        ),
        body: Card(
  ...
  void onUnityCreated(controller) {
    ...
    _unityWidgetController?.postMessage("Canvas", "OnReceiveStringMessage", "LoadScene9");
  }
